...
class scopeLogin(unittest.TestCase):
    ...
    #Click Login button
        ...
        driver.findElement(By.id("id_short_description")).clear()
        driver.findElement(By.id("id_short_description")).sendKeys("Test")
        driver.findElement(By.id("id_activity")).selectByVisibleText("Cash-Assistance for Flood Victims")
        ...
        driver.findElement(By.id("id_default_beneficiary_group"))).selectByVisibleText("Beneficiaries")
        driver.findElement(By.id("id_delivery_mechanism")).selectByVisibleText("TestDeliveryMechanism | Bank account")
